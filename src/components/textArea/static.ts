...
export const classField = "disabled:bg-gray-100 border-gray-300 mt-1.5 w-full rounded-lg border p-3 text-gray-700 sm:text-sm focus:outline-none focus:ring focus:ring-opacity-40"